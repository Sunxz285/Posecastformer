...
class MotionDataset3D(MotionDataset):
    ...
    def __getitem__(self, index):
        ...
        motion_3d = motion_file["data_label"]  # 修改点：data_label -> label
        if self.data_split == "train":
            if self.synthetic or self.gt_2d:
                ...
                motion_2d[:, :, 2] = 1
            elif motion_file["data_input"] is not None:  # 修改点：data_input -> input
                motion_2d = motion_file["data_input"]  # 修改点：data_input -> input
